...
namespace UMF.Unity.EditorUtil
{
    public static class UMFGameViewUtil
    {
        ...
        static UMFGameViewUtil()
        {
            ...
            s_GameView_selectedSizeIndex = s_GameViewType.GetProperty( "selectedSizeIndex", BindingFlags.Instance | BindingFlags.Public );
        ...
        public static int GetSelectedSizeIndex()
        {
            ...
            EditorWindow gv = EditorWindow.GetWindow( s_GameViewType );
            int idx = (int)s_GameView_selectedSizeIndex.GetValue( gv );
