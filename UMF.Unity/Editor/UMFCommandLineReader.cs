...
{
	public class UMFCommandLineReader
	{
		//Config
		...
		public static string GetCommandLine()
		{
			...
			{
				Debug.LogError( "UMFCommandLineReader.cs - GetCommandLine() - Can't find any command line arguments!" );
				return "";
			}
		}
		...
		public static Dictionary<string, string> GetCustomArguments()
		{
			...
			{
				Debug.LogError( "UMFCommandLineReader.cs - GetCustomArguments() - Can't retrieve any custom arguments in the command line [" + commandLineArgs + "]. Exception: " + e );
			...
			foreach( string customArg in customArgs )
			{
				...
				{
					Debug.LogWarning( "UMFCommandLineReader.cs - GetCustomArguments() - The custom argument [" + customArg + "] seem to be malformed." );
				}
			}
		...
		public static string GetCustomArgument( string argumentName )
		{
			...
			{
				Debug.LogWarning( "UMFCommandLineReader.cs - GetCustomArgument() - Can't retrieve any custom argument named [" + argumentName + "] in the command line [" + GetCommandLine() + "]." );
				return "";
			}
		}
	}
