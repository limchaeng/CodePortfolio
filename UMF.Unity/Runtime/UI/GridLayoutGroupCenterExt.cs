...
{
    [AddComponentMenu( "UMF/UI/Grid Layout Group Center Ext" )]
    public class GridLayoutGroupCenterExt : GridLayoutGroup
    {
        public bool m_ActiveCenterAlign = true;

        public override void SetLayoutHorizontal()
        {
            if( m_ActiveCenterAlign )
                SetCellsAlongAxis( 0 );
            else
