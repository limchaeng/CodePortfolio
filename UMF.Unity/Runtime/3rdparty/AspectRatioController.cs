...
// Version 1.0
//
// ref https://github.com/DenchiSoft/UnityAspectRatioController
//////////////////////////////////////////////////////////////////////////
...
namespace UMF.Unity.EXTERNAL
{
	public class AspectRatioController : MonoBehaviour
	{
		...
		private static int m_minWidthPixel = 512;
		public int MinWidthPixel { get => m_minWidthPixel; set => m_minWidthPixel = value; }
		public int MinHeightPixel { get { return Mathf.RoundToInt( m_minWidthPixel / aspect ); } }

		private static int m_maxWidthPixel = 2048;
		public int MaxWidthPixel { get => m_maxWidthPixel; set => m_maxWidthPixel = value; }
		public int MaxHeightPixel { get { return Mathf.RoundToInt( m_maxWidthPixel / aspect ); } }
		...
		private static extern bool EnumThreadWindows( uint dwThreadId, EnumThreadDelegate lpEnumFunc, IntPtr lParam );
		...
		static IntPtr wndProc( IntPtr hWnd, uint msg, IntPtr wParam, IntPtr lParam )
		{
			...
			if( msg == WM_SIZING )
			{
				...
				// Clamp window size.
				int minHeightPixel = Mathf.RoundToInt( m_minWidthPixel / aspect );
				int maxHeightPixel = Mathf.RoundToInt( m_maxWidthPixel / aspect );
